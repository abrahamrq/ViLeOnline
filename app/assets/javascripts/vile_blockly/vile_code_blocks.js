...
Blockly.JavaScript['vile_function'] = function(block) {
  ...
  var value_function_head = Blockly.JavaScript.valueToCode(block, 'function_head', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_parameter'] = function(block) {
  ...
  var value_parameter = Blockly.JavaScript.valueToCode(block, 'parameter', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_if'] = function(block) {
  var value_if_statement = Blockly.JavaScript.valueToCode(block, 'if_statement', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_bool'] = function(block) {
  var value_first_value = Blockly.JavaScript.valueToCode(block, 'first_value', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
  var dropdown_operator = block.getFieldValue('operator');
  var value_second_value = Blockly.JavaScript.valueToCode(block, 'second_value', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_assignment'] = function(block) {
  var text_var_name = block.getFieldValue('var_name');
  var value_assignment = Blockly.JavaScript.valueToCode(block, 'assignment', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
  var code = text_var_name + ' = ' +  value_assignment + ';\n';;
  return code;
};

Blockly.JavaScript['vile_list_element'] = function(block) {
  var value_element = Blockly.JavaScript.valueToCode(block, 'element', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_operation'] = function(block) {
  var value_left_value = Blockly.JavaScript.valueToCode(block, 'left_value', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
  var dropdown_operator = block.getFieldValue('operator');
  var value_right_value = Blockly.JavaScript.valueToCode(block, 'right_value', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
  var code = value_left_value + ' ' + dropdown_operator + ' ' + value_right_value;
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['vile_parenthesis'] = function(block) {
  var value_operation_code = Blockly.JavaScript.valueToCode(block, 'operation_code', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_variable_init_assign'] = function(block) {
  ...
  var value_vile_init_assign = Blockly.JavaScript.valueToCode(block, 'vile_init_assign', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_times_loop'] = function(block) {
  var value_how_many = Blockly.JavaScript.valueToCode(block, 'how_many', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
...
Blockly.JavaScript['vile_while_loop'] = function(block) {
  var value_condition = Blockly.JavaScript.valueToCode(block, 'condition', Blockly.JavaScript.ORDER_ATOMIC).slice(1, -1);
